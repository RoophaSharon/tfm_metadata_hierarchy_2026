...
st.title(methods.title('Approach 2'))
st.caption('Upload a metadata file (CSV / TSV / XLSX / JSON), confirm the column '
           'roles, then build. Full method details and citations in the Method tab.')
...
with st.expander('Advanced settings', expanded=False):
    ...
    with ac2:
        ...
        use_fastopic    = st.checkbox('FASTopic aspects',
...
with tabs[5]:
    ...
    _out_dir = Path(__file__).resolve().parent.parent / 'outputs' / 'approach_2'
